<div x-data="{ files: null }" id="file_upload_{{ name }}" class="mt-1 block w-full px-6 pt-5 pb-6 relative border border-theme-400 dark:border-theme-500 text-theme-800 placeholder-theme-400 dark:text-theme-300 bg-theme-200 dark:bg-theme-700 border-dashed rounded-md">
        ...
        <div class="flex flex-col space-y-1">
            <template x-for="(_,index) in Array.from({ length: files.length })">
                <div class="flex flex-row items-center space-x-2">
                    ...
                    <div class="font-medium grow text-theme-600 dark:text-theme-300 self-center" x-text="files[index].name">Uploading</div>
